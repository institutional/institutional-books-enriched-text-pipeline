...
class TestComputeBPBCLI:
    ...
    @patch("commands.compute_bpb.load_bpb_model")
    @patch("commands.compute_bpb.compute_bpb_in_book")
    def test_skips_books_with_errors(self, mock_compute, mock_load_model, tmp_path: Path):
    ...
    @patch("commands.compute_bpb.load_bpb_model")
    @patch("commands.compute_bpb.compute_bpb_in_book")
    def test_creates_output_directory(self, mock_compute, mock_load_model, tmp_path: Path):
    ...
    @patch("commands.compute_bpb.load_bpb_model")
    @patch("commands.compute_bpb.compute_bpb_in_book")
    def test_resume_skips_processed_books(self, mock_compute, mock_load_model, tmp_path: Path):
