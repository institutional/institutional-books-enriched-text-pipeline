...
def transform_book(book: dict) -> dict:
    ...
    return {
        ...
        # Use the pipeline segmenter's sentence count (len of middlematter_sentences),
        # not metadata["sentence_count"] which is a polyglot re-split (~25% higher and
        # inconsistent with the paragraph/section structure).
        "sentence_count_gen": len(book.get("middlematter_sentences", [])),
