...
def sample_books_by_language(shard_dir: Path, max_books_per_language: int = 20) -> BooksByLangDict:
    """
...
def train_endmatter_classifiers(
    ...
    try:
        training_dir = (
            get_training_data(output_dir=m2v_training_data_dir)
            if m2v_training_data_dir
            else get_training_data()
        )
